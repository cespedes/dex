...
func (arq *AuthRequestQuery) First(ctx context.Context) (*AuthRequest, error) {
	nodes, err := arq.Limit(1).All(newQueryContext(ctx, TypeAuthRequest, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (arq *AuthRequestQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = arq.Limit(1).IDs(newQueryContext(ctx, TypeAuthRequest, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (arq *AuthRequestQuery) Only(ctx context.Context) (*AuthRequest, error) {
	nodes, err := arq.Limit(2).All(newQueryContext(ctx, TypeAuthRequest, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (arq *AuthRequestQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = arq.Limit(2).IDs(newQueryContext(ctx, TypeAuthRequest, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (arq *AuthRequestQuery) All(ctx context.Context) ([]*AuthRequest, error) {
	ctx = newQueryContext(ctx, TypeAuthRequest, "All")
...
func (arq *AuthRequestQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	ctx = newQueryContext(ctx, TypeAuthRequest, "IDs")
...
func (arq *AuthRequestQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeAuthRequest, "Count")
	if err := arq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (arq *AuthRequestQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeAuthRequest, "Exist")
...
func (argb *AuthRequestGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeAuthRequest, "GroupBy")
...
func (ars *AuthRequestSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeAuthRequest, "Select")
