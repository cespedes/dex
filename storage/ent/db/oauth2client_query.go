...
func (oq *OAuth2ClientQuery) First(ctx context.Context) (*OAuth2Client, error) {
	nodes, err := oq.Limit(1).All(newQueryContext(ctx, TypeOAuth2Client, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (oq *OAuth2ClientQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = oq.Limit(1).IDs(newQueryContext(ctx, TypeOAuth2Client, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (oq *OAuth2ClientQuery) Only(ctx context.Context) (*OAuth2Client, error) {
	nodes, err := oq.Limit(2).All(newQueryContext(ctx, TypeOAuth2Client, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (oq *OAuth2ClientQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = oq.Limit(2).IDs(newQueryContext(ctx, TypeOAuth2Client, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (oq *OAuth2ClientQuery) All(ctx context.Context) ([]*OAuth2Client, error) {
	ctx = newQueryContext(ctx, TypeOAuth2Client, "All")
...
func (oq *OAuth2ClientQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	ctx = newQueryContext(ctx, TypeOAuth2Client, "IDs")
...
func (oq *OAuth2ClientQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeOAuth2Client, "Count")
	if err := oq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (oq *OAuth2ClientQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeOAuth2Client, "Exist")
...
func (ogb *OAuth2ClientGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeOAuth2Client, "GroupBy")
...
func (os *OAuth2ClientSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeOAuth2Client, "Select")
