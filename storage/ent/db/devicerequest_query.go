...
func (drq *DeviceRequestQuery) First(ctx context.Context) (*DeviceRequest, error) {
	nodes, err := drq.Limit(1).All(newQueryContext(ctx, TypeDeviceRequest, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (drq *DeviceRequestQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = drq.Limit(1).IDs(newQueryContext(ctx, TypeDeviceRequest, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (drq *DeviceRequestQuery) Only(ctx context.Context) (*DeviceRequest, error) {
	nodes, err := drq.Limit(2).All(newQueryContext(ctx, TypeDeviceRequest, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (drq *DeviceRequestQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = drq.Limit(2).IDs(newQueryContext(ctx, TypeDeviceRequest, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (drq *DeviceRequestQuery) All(ctx context.Context) ([]*DeviceRequest, error) {
	ctx = newQueryContext(ctx, TypeDeviceRequest, "All")
...
func (drq *DeviceRequestQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	ctx = newQueryContext(ctx, TypeDeviceRequest, "IDs")
...
func (drq *DeviceRequestQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeDeviceRequest, "Count")
	if err := drq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (drq *DeviceRequestQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeDeviceRequest, "Exist")
...
func (drq *DeviceRequestQuery) Select(fields ...string) *DeviceRequestSelect {
	...
	sbuild.flds, sbuild.scan = &drq.fields, sbuild.Scan
	return sbuild
}
...
func (drgb *DeviceRequestGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeDeviceRequest, "GroupBy")
...
func (drs *DeviceRequestSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeDeviceRequest, "Select")
