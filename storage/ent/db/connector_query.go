...
func (cq *ConnectorQuery) First(ctx context.Context) (*Connector, error) {
	nodes, err := cq.Limit(1).All(newQueryContext(ctx, TypeConnector, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (cq *ConnectorQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(1).IDs(newQueryContext(ctx, TypeConnector, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (cq *ConnectorQuery) Only(ctx context.Context) (*Connector, error) {
	nodes, err := cq.Limit(2).All(newQueryContext(ctx, TypeConnector, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (cq *ConnectorQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(2).IDs(newQueryContext(ctx, TypeConnector, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (cq *ConnectorQuery) All(ctx context.Context) ([]*Connector, error) {
	ctx = newQueryContext(ctx, TypeConnector, "All")
...
func (cq *ConnectorQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	ctx = newQueryContext(ctx, TypeConnector, "IDs")
...
func (cq *ConnectorQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeConnector, "Count")
	if err := cq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (cq *ConnectorQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeConnector, "Exist")
...
func (cgb *ConnectorGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeConnector, "GroupBy")
...
func (cs *ConnectorSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeConnector, "Select")
